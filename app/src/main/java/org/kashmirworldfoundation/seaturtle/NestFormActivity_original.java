...
public class NestFormActivity_original extends AppCompatActivity {
    private static final String TAG = "***" + NestFormActivity_original.class.getSimpleName();
            ...
            public void onClick(View v) {
                switch(v.getId()) {
                    ...
                    case R.id.save_nest:
                        ...
                        if (saveNestRecord()) {
                            NestFormActivity_original.this.finish();
                        }
                        break;
